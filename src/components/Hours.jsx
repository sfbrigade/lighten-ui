...
export default class Hours extends React.Component {
  ...
  getEditMarkup = (hoursAtoms, dataKey) => {
    return hoursAtoms.map((atom, index) => {
      return <div key={index} className="Hours-line">
        <input className="Hours-day" type="text" value={atom[DAY]} onChange={this.changeHours(dataKey, index, DAY)} />
        <input className="Hours-time" type="text" value={atom[OPEN]} onChange={this.changeHours(dataKey, index, OPEN)} />
        <input className="Hours-time" type="text" value={atom[CLOSE]} onChange={this.changeHours(dataKey, index, OPEN)} />
      </div>
    })
  }
